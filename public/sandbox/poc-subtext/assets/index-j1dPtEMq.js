...
function lv() {
  ...
  function _(d, R, j) {
    ...
    return (
      (R = j.ref),
      { $$typeof: y, type: d, key: C, ref: R !== void 0 ? R : null, props: j }
    );
  }
    ...
    Tr ||
      ...
      (function (y) {
        ...
        var Al = !1,
          ...
          kl = -1;
        function Ut() {
          return nl ? !0 : !(y.unstable_now() - kl < Dl);
        }
        function ql() {
          if (((nl = !1), Al)) {
                  ...
                  t: {
                    for (
                      ...
                      if (typeof J == "function") {
                        ...
                        if (((s = y.unstable_now()), typeof $ == "function")) {
                          (O.callback = $), Ll(s), (z = !0);
                          break t;
                        }
                        O === _(D) && d(D), Ll(s);
        ...
        (y.unstable_IdlePriority = 5),
          ...
          (y.unstable_runWithPriority = function (s, z) {
            switch (s) {
              case 1:
              case 2:
              case 3:
          ...
          (y.unstable_scheduleCallback = function (s, z, B) {
...
function nv() {
  ...
  var C = y.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
  function Q(D, S) {
    if (D === "font") return "";
...
` +
  ...
  var it = Math.clz32 ? Math.clz32 : Xr,
    Yr = Math.log,
    Gr = Math.LN2;
  function Xr(l) {
  ...
  var Pt = Math.random().toString(36).slice(2),
    ...
    xa = "__reactMarker$" + Pt;
  function lc(l) {
    delete l[Ql], delete l[Il], delete l[Pn], delete l[Zr], delete l[Vr];
  }
  function Ve(l) {
    var t = l[Ql];
    if (t) return t;
  ...
  var ft = typeof Object.is == "function" ? Object.is : jm;
  function Qa(l, t) {
    if (ft(l, t)) return !0;
    if (
      typeof l != "object" ||
    ...
    function g(m, r, v, T) {
      ...
      if (typeof v == "object" && v !== null) {
        switch (v.$$typeof) {
          ...
          case Dl:
            return (v = Be(v)), g(m, r, v, T);
        }
        if (ul(v) || Rl(v)) return L !== null ? null : p(m, r, v, T, null);
        if (typeof v.then == "function") return g(m, r, Fu(v), T);
        if (v.$$typeof === El) return g(m, r, wu(m, v), T);
        Iu(m, v);
      }
      return null;
    }
          ...
          l: {
            ...
            switch (Z.tag) {
              ...
              case 0:
                if (
                  ((q = Z.payload),
                  (g = typeof q == "function" ? q.call(yl, M, g) : q),
                  g == null)
                )
                  break l;
                M = O({}, M, g);
  ...
  var Eo = {
      ...
      useCacheRefresh: function () {
        return ($l().memoizedState = $m.bind(null, F));
      },
  ...
  function Zo(l, t, e) {
    if (l !== null)
      if (l.memoizedProps !== t.pendingProps) Hl = !0;
        ...
        if (!bi(l, e) && (t.flags & 128) === 0) return (Hl = !1), Pm(l, t, e);
        Hl = (l.flags & 131072) !== 0;
      }
      ...
      case 5:
        return (
          l === null &&
            al &&
            ((u = a = Sl) &&
              ((a = U0(a, t.type, t.pendingProps, Et)),
              a !== null
                ? ((t.stateNode = a),
                  (Zl = t),
                  (Sl = Tt(a.firstChild)),
    ...
    switch (l.tag) {
      case 26:
        ya(l, t, e),
          l.flags & fu &&
            l.memoizedState !== null &&
            Z0(e, Dt, l.memoizedState, l.memoizedProps);
        break;
      case 5:
        ya(l, t, e);
        break;
  ...
  function vd(l, t, e, a, u, n, c, i, f, h, p, M, g, b) {
    if (
      ((l.timeoutHandle = -1),
      (M = t.subtreeFlags),
      ...
      if (((q = V0(M, q)), q !== null)) {
        (kt = n),
          (l.cancelPendingCommit = q(
            zd.bind(null, l, t, n, e, a, u, c, i, f, p, M, null, g, b)
          )),
          he(l, n, c, !h);
        return;
      }
  ...
  for (var Gi = 0; Gi < Ec.length; Gi++) {
    var Xi = Ec[Gi],
      g0 = Xi.toLowerCase(),
      S0 = Xi[0].toUpperCase() + Xi.slice(1);
    _t(g0, "on" + S0);
  }
  _t(ds, "onAnimationEnd"),
    ...
    _t("focusin", "onFocus"),
    _t("focusout", "onBlur"),
    _t(Hm, "onTransitionRun"),
    _t(Cm, "onTransitionStart"),
    _t(Bm, "onTransitionCancel"),
    ...
    if (!l[Dn]) {
      (l[Dn] = !0),
        Uf.forEach(function (e) {
          e !== "selectionchange" && (b0.has(e) || Li(e, !1, l), Li(e, !0, l));
        });
    ...
    Lf(function () {
      ...
      l: {
        ...
        if (g !== void 0) {
          ...
          0 < Z.length &&
            ((g = new b(g, q, null, e, p)), M.push({ event: g, listeners: Z }));
        }
      }
      if ((t & 7) === 0) {
        l: {
          ...
          if (
            ...
            if (
              ...
              t: {
                for (Z = p0, m = b, r = q, v = 0, T = m; T; T = Z(T)) v++;
                T = 0;
...
`
        ...
        for (var q in e)
          (g = e[q]),
            e.hasOwnProperty(q) &&
              g != null &&
              !a.hasOwnProperty(q) &&
              (q === "selected" ? (l.selected = !1) : hl(l, t, q, null, a, g));
        for (f in a)
          (g = a[f]),
            (b = e[f]),
            a.hasOwnProperty(f) &&
  ...
  var Ft = z.d;
  z.d = { f: j0, r: x0, D: H0, C: C0, L: B0, m: q0, X: G0, S: Y0, M: X0 };
  function j0() {
    var l = Ft.f(),
      t = En();
    return l || t;
...
function hv(y) {
  return new Promise((N, _) => {
    ...
    (d.onloadend = () => N(d.result)), (d.onerror = _), d.readAsDataURL(y);
  });
}
function yv(y) {
  return Oa.find(N => N.id === y);
}
function gv({
  onFileSelected: y,
  onLoadExample: N,
...
async function Mv(y, N, _) {
  const d = await yf(),
    R = `video-${Date.now()}`,
    j = { id: R, name: y, manifest: N, videoBlob: _, createdAt: Date.now() };
...
async function _v(y) {
  ...
  return new Promise((_, d) => {
    const C = N.transaction([Te], "readonly").objectStore(Te).get(y);
...
function Uv({
  ...
  const Q = V.useRef(null),
    ...
    H = V.useRef(null),
    [O, G] = V.useState(0),
    [K, ol] = V.useState(y.video.duration),
    [dl, nl] = V.useState(!1),
    [pl, Wl] = V.useState(1),
  ...
  const kl = V.useCallback(
    ...
    Fl = () => y.transcript.findIndex(s => O >= s.start && O < s.end),
    ul = () => {
      for (let s = y.screenshots.length - 1; s >= 0; s--)
        if (O >= y.screenshots[s].timestamp) return s;
      return 0;
    };
  return A.jsxs("div", {
    className: "app",
                ...
                children: A.jsxs("div", {
                  ...
                  children: [
                    ...
                    A.jsx("div", {
                      ...
                      children: y.screenshots.map((s, z) => {
                        const B = s.timestamp,
                          J =
                            z < y.screenshots.length - 1
                              ? y.screenshots[z + 1].timestamp
                              : K,
                          $ = J - B,
                          o = (B / K) * 100,
                          E = ($ / K) * 100;
...
async function Rv(y, N, _, d) {
  return new Promise((R, j) => {
    const C = () => {
      y.removeEventListener("seeked", C),
        d.drawImage(y, 0, 0, _.width, _.height);
      const Q = d.getImageData(0, 0, _.width, _.height);
      R(Q);
    };
    y.addEventListener("seeked", C),
      (y.currentTime = Math.min(N, y.duration - 0.001)),
      setTimeout(() => {
        y.removeEventListener("seeked", C), j(new Error("Seek timeout"));
      }, 5e3);
  });
}
async function jv(y, N = {}, _) {
...
async function xv(y, N, _ = 160, d) {
  return new Promise((R, j) => {
    const C = y.videoHeight / y.videoWidth,
      Q = Math.round(_ * C),
    ...
    const H = Math.min(N, y.duration - 0.001),
      O = () => {
      ...
      G = () => {
        y.removeEventListener("seeked", G),
...
function Hv() {
  ...
  const Dl = V.useCallback(async ul => {
      ...
      try {
        ...
        const { video: z, metadata: B } = await pv(ul);
        await new Promise(U => {
          z.readyState >= 3 ? U() : (z.oncanplay = () => U());
        }),
          O(5);
        const J = await Ev(ul, U => {
          O(5 + U * 0.15);
        });
        W.current ||
          (S("loading-model"),
        ...
        const o = await jv(z, { threshold: 27, minSceneLength: 0.5 }, U => {
          O(50 + U * 0.3);
        });
    ...
    ql = V.useCallback(async ul => {
      ...
      if (s) {
        ...
        try {
          O(10);
          const { manifest: z, videoBlob: B } = await vv(s);
          O(80);
...
sv.createRoot(document.getElementById("root")).render(
  A.jsx(V.StrictMode, { children: A.jsx(Hv, {}) })
);
