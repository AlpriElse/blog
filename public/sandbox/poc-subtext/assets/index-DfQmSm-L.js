...
function P0() {
  ...
  function _(d, R, x) {
    ...
    if (
      ...
      x = {};
      for (var X in R) X !== "key" && (x[X] = R[X]);
    } else x = R;
    return (
      (R = x.ref),
      { $$typeof: g, type: d, key: C, ref: R !== void 0 ? R : null, props: x }
    );
  }
  ...
  function s(o, E, j, U, L) {
        ...
        case "object":
          switch (o.$$typeof) {
            ...
            case N:
              ...
              break;
            case H:
              return (cl = o._init), s(cl(o._payload), E, j, U, L);
          }
      }
    if (cl)
      return (
    ...
    if (Nl(o))
      for (var zl = 0; zl < o.length; zl++)
        (U = o[zl]), (k = Yl + Fl(U, zl)), (cl += s(U, E, j, k, L));
    else if (((zl = K(o)), typeof zl == "function"))
      for (o = zl.call(o), zl = 0; !(U = o.next()).done; )
        (U = U.value), (k = Yl + Fl(U, zl++)), (cl += s(U, E, j, k, L));
    else if (k === "object") {
      if (typeof o.then == "function") return s(ul(o), E, j, U, L);
      throw (
        ((E = String(o)),
        Error(
  ...
  return (
    ...
    (w.cloneElement = function (o, E, j) {
      ...
      var U = dl({}, o.props),
        L = o.key;
      if (E != null)
        for (k in (E.key !== void 0 && (L = "" + E.key), E))
          !Dl.call(E, k) ||
            k === "key" ||
            k === "__self" ||
            k === "__source" ||
    ...
    (w.createElement = function (o, E, j) {
      var U,
        L = {},
        k = null;
      if (E != null)
    ...
    (w.isValidElement = Bl),
    (w.lazy = function (o) {
      return { $$typeof: H, _payload: { _status: -1, _result: o }, _init: q };
    }),
    (w.memo = function (o, E) {
    ...
    (w.useActionState = function (o, E, j) {
    ...
    (w.useImperativeHandle = function (o, E, j) {
    ...
    (w.useSyncExternalStore = function (o, E, j) {
      return W.H.useSyncExternalStore(o, E, j);
    }),
    ...
    Tr ||
      ...
      (function (g) {
            ...
            l: for (var J = 0, $ = s.length, o = $ >>> 1; J < o; ) {
              ...
              if (0 > R(j, q))
                U < $ && 0 > R(L, j)
                  ? ((s[J] = L), (s[U] = q), (J = U))
                  : ((s[J] = j), (s[E] = q), (J = E));
              else if (U < $ && 0 > R(L, q)) (s[J] = L), (s[U] = q), (J = U);
              else break l;
            }
          }
          return z;
        ...
        (g.unstable_IdlePriority = 5),
          ...
          (g.unstable_scheduleCallback = function (s, z, q) {
...
function cv() {
  ...
  var U = o(null),
    ...
    cl = o(null);
  function Yl(l, t) {
    switch ((j(k, t), j(L, l), j(U, null), t.nodeType)) {
      case 9:
      case 11:
  ...
  function Au(l) {
    L.current === l && (E(U), E(L)),
      cl.current === l && (E(cl), (Su._currentValue = q));
  }
  var Vn, gf;
  function Ae(l) {
    if (Vn === void 0)
...
` +
  ...
  var wn = Object.prototype.hasOwnProperty,
    ...
    Cr = g.log,
    qr = g.unstable_setDisableYieldValue,
    Na = null,
    ct = null;
  function It(l) {
    if (
      (typeof Cr == "function" && qr(l),
  ...
  var it = Math.clz32 ? Math.clz32 : Gr,
    ...
    Yr = Math.LN2;
  function Gr(l) {
    return (l >>>= 0), l === 0 ? 32 : (31 - ((Br(l) / Yr) | 0)) | 0;
  }
  var _u = 256,
    Du = 262144,
    Ou = 4194304;
  ...
  var om = O({}, Ba, {
    ...
    pm = Pl(bm),
    Em = [9, 13, 27, 32],
    vc = qt && "CompositionEvent" in window,
    Ga = null;
  qt && "documentMode" in document && (Ga = document.documentMode);
  var zm = qt && "TextEvent" in window && !Ga,
    wf = qt && (!vc || (Ga && 8 < Ga && 11 >= Ga)),
    Wf = " ",
    $f = !1;
  function kf(l, t) {
    switch (l) {
  ...
  var jm = qt && "documentMode" in document && 11 >= document.documentMode,
    Pe = null,
    Sc = null,
    Za = null,
    bc = !1;
  ...
  function zs(l) {
    ...
    switch (((t[Ql] = l), (t[Il] = a), e)) {
      ...
      case "select":
        ...
        break;
      case "textarea":
        ll("invalid", t), Bf(t, a.value, a.defaultValue, a.children);
    }
    (e = a.children),
  ...
  function Wu(l, t) {
    t === null ? j(Ce, Ce.current) : j(Ce, t.pool);
  }
  function Ds() {
    var l = qc();
  ...
  function js(l) {
    ...
    function u(m, r) {
      return (m = Bt(m, r)), (m.index = 0), (m.sibling = null), m;
    }
    function n(m, r, v) {
      return (
        (m.index = v),
    ...
    function p(m, r, v, T, Q) {
      return r === null || r.tag !== 7
        ? ((r = Re(v, m.mode, T, Q)), (r.return = m), r)
        : ((r = u(r, v)), (r.return = m), r);
    }
    function M(m, r, v) {
      if (
    ...
    function y(m, r, v, T) {
      ...
      if (
        ...
        return Q !== null ? null : i(m, r, "" + v, T);
      if (typeof v == "object" && v !== null) {
        switch (v.$$typeof) {
          case K:
            return v.key === Q ? f(m, r, v, T) : null;
          case ol:
            return v.key === Q ? h(m, r, v, T) : null;
          case Dl:
            return (v = qe(v)), y(m, r, v, T);
        }
        if (ul(v) || Rl(v)) return Q !== null ? null : p(m, r, v, T, null);
    ...
    function b(m, r, v, T, Q) {
      if (
        (typeof T == "string" && T !== "") ||
        typeof T == "number" ||
        typeof T == "bigint"
      )
        return (m = m.get(v) || null), i(r, m, "" + T, Q);
      if (typeof T == "object" && T !== null) {
        switch (T.$$typeof) {
          case K:
            return (
              (m = m.get(T.key === null ? v : T.key) || null), f(r, m, T, Q)
            );
          case ol:
            return (
              (m = m.get(T.key === null ? v : T.key) || null), h(r, m, T, Q)
            );
          case Dl:
            return (T = qe(T)), b(m, r, v, T, Q);
        }
        if (ul(T) || Rl(T)) return (m = m.get(v) || null), p(r, m, T, Q, null);
        if (typeof T.then == "function") return b(m, r, v, Fu(T), Q);
        if (T.$$typeof === El) return b(m, r, v, wu(r, T), Q);
        Iu(r, T);
      }
      return null;
    }
    function B(m, r, v, T) {
      for (
        var Q = null, il = null, Y = r, I = (r = 0), el = null;
        Y !== null && I < v.length;
        I++
      ) {
        ...
        l && Y && fl.alternate === null && t(m, Y),
          (r = n(fl, r, I)),
          il === null ? (Q = fl) : (il.sibling = fl),
          (il = fl),
          (Y = el);
      }
      if (I === v.length) return e(m, Y), al && Yt(m, I), Q;
      if (Y === null) {
        for (; I < v.length; I++)
          (Y = M(m, v[I], T)),
            Y !== null &&
              ((r = n(Y, r, I)),
              il === null ? (Q = Y) : (il.sibling = Y),
              (il = Y));
        return al && Yt(m, I), Q;
      }
    ...
    function Z(m, r, v, T) {
      ...
      for (
        var Q = null, il = null, Y = r, I = (r = 0), el = null, fl = v.next();
        Y !== null && !fl.done;
        I++, fl = v.next()
      ) {
        Y.index > I ? ((el = Y), (Y = null)) : (el = Y.sibling);
        ...
        l && Y && ze.alternate === null && t(m, Y),
          (r = n(ze, r, I)),
          il === null ? (Q = ze) : (il.sibling = ze),
          (il = ze),
          (Y = el);
      }
      if (fl.done) return e(m, Y), al && Yt(m, I), Q;
      if (Y === null) {
      ...
      if (
        ...
        switch (v.$$typeof) {
          ...
          case ol:
            ...
            return c(m);
          case Dl:
            return (v = qe(v)), yl(m, r, v, T);
        }
        if (ul(v)) return B(m, r, v, T);
        if (Rl(v)) {
          if (((Q = Rl(v)), typeof Q != "function")) throw Error(d(150));
          return (v = Q.call(v)), Z(m, r, v, T);
        }
          ...
          l: {
            ...
            switch (Z.tag) {
              ...
              case 0:
                if (
                  ((B = Z.payload),
                  (y = typeof B == "function" ? B.call(yl, M, y) : B),
                  y == null)
                )
                  break l;
                M = O({}, M, y);
  ...
  var da = o(null),
    Pu = o(0);
  function qs(l, t) {
    (l = $t), j(Pu, l), j(da, t), ($t = l | t.baseLanes);
  }
  function Qc() {
    j(Pu, $t), j(da, da.current);
  }
  function Zc() {
  ...
  function Vc(l) {
    j(Ol, Ol.current), j(ot, l), zt === null && (zt = l);
  }
  function Bs(l) {
    l.tag === 22
      ? (j(Ol, Ol.current), j(ot, l), zt === null && (zt = l))
  ...
  function se() {
    j(Ol, Ol.current), j(ot, ot.current);
  }
  function dt(l) {
  ...
  function Ho(l, t, e, a) {
    ...
    if (
      ...
      n !== null
        ? (Wu(t, n.cachePool), qs(t, n), se(), (t.memoizedState = null))
  ...
  function Fm(l, t, e) {
    ...
    if (n !== null) {
      var c = n.dehydrated;
      if ((Vc(t), u))
        if (t.flags & 256) (t.flags &= -257), (t = qo(l, t, e));
  ...
  function Xo(l, t, e) {
    ...
    return u
      ? (se(),
        ...
        (f = l.child),
        (h = f.sibling),
        (a = Bt(f, { mode: "hidden", children: a.children })),
        (a.subtreeFlags = f.subtreeFlags & 65011712),
        h !== null ? (i = Bt(h, i)) : ((i = Re(i, u, e, null)), (i.flags |= 2)),
        (i.return = t),
        (a.return = t),
        (a.sibling = i),
        (t.child = a),
  ...
  var Kt = !1,
    ...
    Xl = null;
  function t0(l, t) {
    if (((l = l.containerInfo), (Ki = qn), (l = fs(l)), gc(l))) {
    ...
    for (
      Ji = { focusedElem: l, selectionRange: e }, qn = !1, Xl = t;
      Xl !== null;
  ...
  function pd(l) {
    ...
    switch (t.tag) {
      case 15:
      case 0:
        t = Bo(e, t, t.pendingProps, t.type, void 0, tl);
        break;
      case 11:
        t = Bo(e, t, t.pendingProps, t.type.render, t.ref, tl);
        break;
      case 5:
        $c(t);
      default:
              ...
              if ((p === void 0 && (p = h), "selectionStart" in i))
                ...
                if (y.getSelection) {
                  var b = y.getSelection(),
                    ...
                    Z = Math.min(f.start, B),
                    yl = f.end === void 0 ? Z : Math.min(f.end, B);
  ...
  function Md() {
    if (ql === 4 || ql === 3) {
      ...
      (t.subtreeFlags & 10256) !== 0 || (t.flags & 10256) !== 0
        ? (ql = 5)
        : ((ql = 0), (ba = ve = null), _d(l, l.pendingLanes));
  ...
  function Dd() {
    ...
    try {
      ...
      var n = ve,
        c = kt;
      if (((ql = 0), (ba = ve = null), (kt = 0), (sl & 6) !== 0))
        throw Error(d(331));
      var i = sl;
      if (
        ((sl |= 4),
  ...
  function h0(l, t, e, a, u) {
    if (t === "submit" && e && e.stateNode === u) {
      ...
      c &&
        ...
        t !== null && ((n = t), (c = null)));
      var i = new Bu("action", "action", null, a, u);
      l.push({
        event: i,
        listeners: [
          {
    ...
    Lf(function () {
      ...
      l: {
        ...
        if (y !== void 0) {
          ...
          0 < Z.length &&
            ((y = new b(y, B, null, e, p)), M.push({ event: y, listeners: Z }));
        }
      }
      if ((t & 7) === 0) {
        l: {
          ...
          if (
            ...
            if (
              ...
              t: {
                for (Z = b0, m = b, r = B, v = 0, T = m; T; T = Z(T)) v++;
                T = 0;
                for (var Q = r; Q; Q = Z(Q)) T++;
                for (; 0 < v - T; ) (m = Z(m)), v--;
                for (; 0 < T - v; ) (r = Z(r)), T--;
                for (; v--; ) {
...
`
        ...
        for (var B in e)
          (y = e[B]),
            e.hasOwnProperty(B) &&
              y != null &&
              !a.hasOwnProperty(B) &&
              (B === "selected" ? (l.selected = !1) : hl(l, t, B, null, a, y));
        for (f in a)
          (y = a[f]),
            (b = e[f]),
            a.hasOwnProperty(f) &&
  ...
  var Ft = z.d;
  z.d = { f: R0, r: j0, D: x0, C: H0, L: C0, m: q0, X: Y0, S: B0, M: G0 };
  function R0() {
    var l = Ft.f(),
      t = En();
    return l || t;
  ...
  function af(l, t, e, a) {
    if (qn) {
      var u = uf(a);
      if (u === null) Zi(l, t, a, Bn, e), mr(l, a);
        ...
        for (; u !== null; ) {
          ...
          if (((n = uf(a)), n === null && Zi(l, t, a, Bn, e), n === u)) break;
          u = n;
        }
...
async function ov(g) {
  ...
  const d = await _.json(),
    R = await fetch(`${N}/video.mp4`);
  if (!R.ok) throw new Error(`Failed to fetch example video: ${R.statusText}`);
  const x = await R.blob(),
    C = await Promise.all(
      d.screenshots.map(async X => {
        try {
          const D = await fetch(`${N}/screenshots/${X.filename}`);
          if (D.ok) {
          ...
          console.warn(`Failed to load screenshot ${X.filename}:`, D);
        }
        return X;
      })
    );
  return { manifest: { ...d, screenshots: C }, videoBlob: x };
}
function dv(g) {
...
function mv({
  ...
  const [R, x] = V.useState(!1),
    [C, X] = V.useState(!1),
    D = V.useCallback(G => {
      G.preventDefault(), x(!0);
    }, []),
    S = V.useCallback(G => {
      G.preventDefault(), x(!1);
    }, []),
    H = V.useCallback(
      G => {
        G.preventDefault(), x(!1);
...
async function gv(g, N) {
  ...
  try {
    ...
    N?.(60);
    const x = R.numberOfChannels,
      C = R.length,
      X = R.sampleRate;
    if (X === 16e3 && x === 1) return N?.(100), R.getChannelData(0);
    const D = new Float32Array(C);
    for (let S = 0; S < C; S++) {
      let H = 0;
      for (let O = 0; O < x; O++) H += R.getChannelData(O)[S];
      D[S] = H / x;
    }
    if ((N?.(80), X !== 16e3)) {
      const S = Sv(D, X, 16e3);
...
async function Ev(g, N, _) {
  const d = await yf(),
    R = `video-${Date.now()}`,
    x = { id: R, name: g, manifest: N, videoBlob: _, createdAt: Date.now() };
  return new Promise((C, X) => {
    const H = d.transaction([Te], "readwrite").objectStore(Te).add(x);
    (H.onsuccess = () => C(R)), (H.onerror = () => X(H.error));
  });
}
async function zv(g) {
  const N = await yf();
...
async function Tv() {
  const g = await yf();
  return new Promise((N, _) => {
    const x = g.transaction([Te], "readonly").objectStore(Te).getAll();
    (x.onsuccess = () => N(x.result || [])), (x.onerror = () => _(x.error));
  });
}
function Av({
  currentVideoId: g,
        ...
        children: [
          A.jsxs("button", {
            ...
            children: [
              ...
              A.jsx("svg", {
                className: `dropdown-arrow ${x ? "open" : ""}`,
                width: "12",
                height: "12",
                viewBox: "0 0 24 24",
                fill: "none",
...
function Mv({
  ...
  V.useEffect(() => {
    ...
    return (
      s.addEventListener("durationchange", j),
      s.addEventListener("play", U),
      s.addEventListener("playing", U),
      s.addEventListener("pause", L),
      ...
      s.paused || o(),
      () => {
        s.removeEventListener("durationchange", j),
          s.removeEventListener("play", U),
          s.removeEventListener("playing", U),
          s.removeEventListener("pause", L),
  ...
  const kl = V.useCallback(
      s => {
        ...
        const z = s.clientX,
          ...
          J = o => {
            if (!W.current) return;
            const E = Math.max(200, Math.min(800, q + (o.clientX - z)));
            Ll(E);
          },
          $ = () => {
            (W.current = !1),
      ...
      s => {
        ...
        const z = s.clientY,
          ...
          J = o => {
            ...
            const E = Math.max(100, Math.min(400, q - (o.clientY - z)));
            Al(E);
          },
          $ = () => {
            (Dl.current = !1),
    ...
    Bl = s => {
      X.current && ((X.current.currentTime = s), G(s));
    },
    Rl = () => {
      const s = X.current;
      s &&
    ...
    Mt = s => {
      ...
      const z = H.current,
        q = S.current.getBoundingClientRect(),
        J = s.clientX - q.left + z.scrollLeft,
        $ = q.width * pl,
        o = J / $;
      Bl(o * K);
    },
          ...
          A.jsxs("div", {
            ...
            children: [
              ...
              A.jsxs("div", {
                ...
                children: [
                  A.jsx("video", { ref: X, src: N, onClick: Rl }),
                  A.jsxs("div", {
                      ...
                      children: g.screenshots.map((s, z) => {
                        ...
                        return A.jsx(
                          "div",
                          {
                            ...
                            onClick: j => {
                              j.stopPropagation(), Bl(s.timestamp);
                            },
                            title: `Clip ${z + 1}: ${Da(q)} - ${Da(J)}`,
                            children: A.jsx("div", {
...
async function Dv(g, N, _, d) {
  return new Promise((R, x) => {
    const C = () => {
      g.removeEventListener("seeked", C),
        d.drawImage(g, 0, 0, _.width, _.height);
      const X = d.getImageData(0, 0, _.width, _.height);
      R(X);
    };
    g.addEventListener("seeked", C),
      (g.currentTime = Math.min(N, g.duration - 0.001)),
      setTimeout(() => {
        g.removeEventListener("seeked", C), x(new Error("Seek timeout"));
      }, 5e3);
  });
}
async function Ov(g, N = {}, _) {
  const { threshold: d = 27, minSceneLength: R = 0.5, sampleRate: x = 2 } = N,
    C = g.duration,
    X = 1 / x,
  ...
  let G = null,
    K = 0,
    ol = 0;
  const dl = Math.ceil(C / X);
  for (let nl = 0; nl < C; nl += X)
    try {
      const pl = await Dv(g, nl, S, O);
      if (G && nl - K >= R) {
        const Wl = _v(pl, G);
...
async function Uv(g, N, _ = 160, d) {
  return new Promise((R, x) => {
    ...
    if (!S) {
      x(new Error("Could not get canvas context"));
      return;
    }
    const H = Math.min(N, g.duration - 0.001),
      O = () => {
        S.drawImage(g, 0, 0, _, X);
    ...
    g.addEventListener("seeked", G),
      ...
      setTimeout(() => {
        ...
        try {
          ...
          x(new Error("Thumbnail generation timeout"));
        }
      }, 5e3);
  });
}
function Nv() {
  ...
  const Dl = V.useCallback(async ul => {
      ...
      try {
        ...
        const { video: z, metadata: q } = await yv(ul);
        await new Promise(U => {
          z.readyState >= 3 ? U() : (z.oncanplay = () => U());
        }),
          O(5);
        const J = await gv(ul, U => {
          O(5 + U * 0.15);
        });
        W.current ||
          (S("loading-model"),
          await new Promise(U => {
            const L = () => {
              W.current ? U() : setTimeout(L, 100);
            };
            L();
          })),
          S("transcribing"),
          O(20);
        const $ = await new Promise((U, L) => {
          (Nl.current = U),
            (Al.current = L),
            Ll.current?.postMessage({ type: "transcribe", audio: J });
        });
        O(50), S("detecting-scenes");
        const o = await Ov(z, { threshold: 27, minSceneLength: 0.5 }, U => {
          O(50 + U * 0.3);
        });
        ...
        K(j), El(q.filename), S("complete"), O(100);
        try {
          const U = ul,
            L = await Ev(q.filename, j, U);
          pl(L);
        } catch (U) {
    ...
    Bl = V.useCallback(async ul => {
      const s = rv(ul);
      if (s) {
        N("processing"), dl(null), S("loading-model"), O(0);
        try {
          O(10);
          const { manifest: z, videoBlob: q } = await ov(s);
          O(80);
          const J = URL.createObjectURL(q);
...
fv.createRoot(document.getElementById("root")).render(
  A.jsx(V.StrictMode, { children: A.jsx(Nv, {}) })
);
