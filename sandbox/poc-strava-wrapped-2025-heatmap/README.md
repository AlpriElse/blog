This is vibe coded to all hell, so there's definitely a lot of weird artifacts in here btw
...
cd sandbox/my-project && npm run dev
...
- Uses `npx tsx` to run the TypeScript build orchestrator
